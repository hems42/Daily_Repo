...
public  class DBSQLiteOfAppointment extends SQLiteOpenHelper  {
    ...
    private static String dataBasePatient_table_name = "AppointmentInformations";
    ...
    public DBSQLiteOfAppointment(@Nullable Context context) {
    ...
    public boolean addPatientAppointment(VisitInformations visitInformations) {
    ...
    public boolean deletePatientAppointment(VisitInformations visitInformations) {
        SQLiteDatabase db = this.getWritableDatabase();
...
/*
    ...
    public boolean deleteAllAppointmentOfPatient(String tc_no) {
        SQLiteDatabase db = this.getWritableDatabase();

        int i = db.delete(dataBasePatient_table_name, dataBasePatient_TC_NO  + " = ? ", new String[]{tc_no});
/*
        db.execSQL("DELETE FROM "+dataBasePatient_table_name+ " WHERE "+ dataBasePatient_TC_NO +"="+"'"+visitInformations.tc_no+"'"+ " AND "
    ...
    public boolean deleteAllAppointment() {
        ...
        db.execSQL("DELETE FROM "+dataBasePatient_table_name+";");
    ...
    public boolean updatePatientAppointment(VisitInformations visitoutOfDate,VisitInformations visitcurrent) {
    ...
    public VisitInformations getAppointment(String patient_tc, String visit_day) {
        ...
        String query = "SELECT * FROM " + dataBasePatient_table_name + " WHERE "+dataBasePatient_TC_NO+"=" + "'" +patient_tc +"'" + " AND  "
                +dataBasePatient_scheduled_appointment_date+"=" + "'" +visit_day +"'";
    ...
    public ArrayList<VisitInformations> getAllAppointmentsOfPatient(String tc_no)
    {
    ...
    public ArrayList<VisitInformations> getAllAppointments()
    {
    ...
    public ArrayList<VisitInformations> getAllAppointments(String date)
    {

        SQLiteDatabase db = this.getReadableDatabase();
        VisitInformations  visitInformations;
        ArrayList<VisitInformations> AllvisitInformations= new ArrayList<>();
        String query = "SELECT * FROM " + dataBasePatient_table_name+ " WHERE "+ dataBasePatient_scheduled_appointment_date +" = "+ "'"+date+"'";
        Cursor cursor = db.rawQuery(query, null);
    ...
    public ArrayList<VisitInformations> getAllAppointmentsOfPatient()
    {
    ...
    public String getPatientOfSex(String tc_no) throws ParseException {
       return dbsqLiteOfAllPatients.getPatient(tc_no).sex;
    }


    public boolean isContainAppointment(VisitInformations visitInformations) {
